 ...
 * `~/.gbrain/page-locks/<sha256-of-slug>.lock` with exclusive creation,
 * holder tokens, and PID-liveness reclamation. Multi-process safe — two `gbrain` invocations writing
